...
% Basalt @ 34 °C with effective Henry scale factors, H2S flux patch,
...
% adjust if needed
%%% (Basalt): use 34 °C base constants + scale factors (solubility variant Hscp=c/p)
Hcp_H2_base  = 0.78;  % H2  (34 °C) (mmol/L/atm)
Hcp_CO2_base = 34.0;  % CO2 (34 °C) (mmol/L/atm)
Hcp_H2S_base = 90.0;  % H2S (34 °C) (mmol/L/atm)
...
raw = readmatrix('Muller_2024_H2_Basalt_at_34C.txt');
t_exp       = raw(:,1);  % days
...
fileID = fopen('Basalt_34C_inc_rates.dat','w');
...
fclose(fileID);
fprintf('Wrote Basalt_34C_inc_rates.dat (incl. Fe_pool and reaction rates)\n');

% -------------------- Plots --------------------
%% Figure 1: Gases & Aqueous - Basalt (34 °C)
species = {'nH2_g','nCO2_g','nCH4_g','nH2S_g','H2(aq)','CO2(aq)','SO4','FeS','Biomass','Acetate','HCO3','S_{aq}^{tot}','Fe_{pool}'};
figure('Name','Gases & Aqueous - Basalt (34 °C)');
