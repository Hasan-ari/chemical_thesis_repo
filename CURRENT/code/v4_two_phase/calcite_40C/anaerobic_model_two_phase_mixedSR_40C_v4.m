...
% Calcite @ 40 °C with effective Henry scale factors, H2S flux patch,
...
% adjust if needed
%%% (Calcite): use 40 °C base constants + scale factors (solubility variant Hscp=c/p)
Hcp_H2_base  = 0.75;  % H2  (40 °C) (mmol/L/atm)
Hcp_CO2_base = 30.0;  % CO2 (40 °C) (mmol/L/atm)
...
raw = readmatrix('Muller_2024_H2_Calcite_at_40C.txt');
t_exp       = raw(:,1);  % days
...
save('best_fit_params_Calcite_40C.mat','p_fit','env','y0');
...
fileID = fopen('Calcite_40C_inc_rates.dat','w');
...
fclose(fileID);
fprintf('Wrote Calcite_40C_inc_rates.dat (incl. Fe_pool and reaction rates)\n');

% -------------------- Plots --------------------
%% Figure 1: Gases & Aqueous - Calcite (40 °C)
species = {'nH2_g','nCO2_g','nCH4_g','nH2S_g','H2(aq)','CO2(aq)','SO4','FeS','Biomass','Acetate','HCO3','S_{aq}^{tot}','Fe_{pool}'};
figure('Name','Gases & Aqueous - Calcite (40 °C)');
